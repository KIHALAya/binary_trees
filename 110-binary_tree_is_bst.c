 ...
 * @tree: Pointer to the root node of the tree to check
 * @min: Pointer to the minimum value that a node in the tree can have
 * @max: Pointer to the maximum value that a node in the tree can have
 *
 * Return: 1 if tree is a valid BST, 0 otherwise
 */
int is_bst_util(
		...
		const binary_tree_t *max)
{
	...
	return (
			is_bst_util(tree->left, min, tree) &&
